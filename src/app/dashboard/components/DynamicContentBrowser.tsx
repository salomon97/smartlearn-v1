    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <h2 className="text-3xl font-black text-gray-900">{selectedSubject} <span className="text-brand-orange">|</span> {gradeLevel}</h2>
                
                {/* Tabs */}
                <div className="flex p-1 bg-gray-100 rounded-2xl overflow-x-auto max-w-full">
                    {[
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold transition-all whitespace-nowrap ${
                                selectedType === tab.id ? "bg-white text-gray-900 shadow-sm" : "text-gray-500 hover:text-gray-700"
                            }`}
                        >
